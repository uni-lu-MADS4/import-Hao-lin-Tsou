...
```{r}
# Your answer in code
download.file("https://biostat2.uni.lu/practicals/data/blood_fat.csv","data/blood_fat.csv")
renv::restore()
library(readr)
```
...
> Your answer as text
the type of age column is douuble
...
```{r}
# Your answer in code
blood_fat <- read_delim("data/blood_fat.csv",
